...
confusionMatrix(test_results$LR, test_results$obs, positive = "X1")
confusionMatrix(test_results$LDA, test_results$obs, positive = "X1")
confusionMatrix(test_results$PLR, test_results$obs, positive = "X1")
confusionMatrix(test_results$NSC, test_results$obs, positive = "X1")
